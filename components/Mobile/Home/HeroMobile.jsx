...
function HeroMobile() {
  return (
    <div className='bg-[#FFD23F] py-[30px] px-[20px] space-y-[28px]'>
      ...
      <Button className="bg-[#5200FF] rounded-full text-[15px]">Connect Now</Button>

      <Image src={"/mobile/heroBg.png"} alt='' height={258} width={350} className='h-[257.833px] object-contain' />
    </div>
  )
}
