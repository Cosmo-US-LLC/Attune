...
function HeroMobile() {
  return (
    ...
    <img src={"/mobile/hero/Hero-Image-mob.webp"} alt='' className=' h-[300px] object-left object-cover' />
    </div>
    <div className='bg-[#95ADF0] py-[30px] px-[20px] space-y-[28px]'>
      <div className='space-y-6 text-white'>
      <p className="font-miniature text-[52.627px]  leading-[52.627px]">
          <span className="font-[600]"> Feeling </span>  <br /> <span className="text-[#E5FF7D] italic"> Challenges? </span>

        </p>
        <p className="text-[15px] leading-[21px]">
        Life’s pressures can feel overwhelming, especially when you’re managing stress, anxiety, or emotional barriers. You don’t have to go through it alone.

        </p>
      </div>
      
      <Button className="bg-[#5200FF] rounded-full text-[15px]">Get Support Now
