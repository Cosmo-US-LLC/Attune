  ...
  return (
    ...
    <div className='bg-[#95ADF0] py-[30px] px-[20px] space-y-[28px]'>
      ...
      <p className="font-miniature text-[52.627px]  leading-[52.627px]">
          <span className="font-[600]"> Feeling </span>  <br /> <span className="text-[#E5FF7D] italic"> Disconnected </span>

        </p>
        <p className="text-[15px] leading-[21px]">
          We understand how challenging it can be to navigate life. Let us help you find the connection and understanding you deserve.

        </p>
      </div>
      
      <Button className="bg-[#5200FF] rounded-full text-[15px]">Talk to Someone Now
