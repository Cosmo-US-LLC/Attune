...
function WhyChoose() {
  ...
  return (
    <div className="bg-white px-5 py-[30px] space-y-[24px]">
          ...
          <CarouselContent>
            <CarouselItem className="basis-1/1 w-full">
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-black grid grid-cols-2">
                    <td className="p-[10px] text-[15px]">Affordability</td>
                    <td className="p-[10px] border-l border-black text-[15px] flex items-center gap-[10px]">
                      <div><svg
                        width="16"
                        height="17"
                        viewBox="0 0 16 17"
                  ...
                  <tr className="border-b border-black grid grid-cols-2">
                    <td className="p-[10px] text-[15px] flex items-center">Affordability</td>
                    <td className="p-[10px] border-l border-black text-[15px] flex items-center gap-[10px]">
                      <div><svg
                        width="16"
                        height="16"
                  ...
                  <tr className="border-b border-black grid grid-cols-2">
                    <td className="p-[10px] text-[15px]">Approachability</td>
                    <td className="p-[10px] border-l border-black text-[15px] flex items-center gap-[10px]">
                      <div><svg
                        width="16"
                        height="16"
                  ...
                  <tr className="border-b border-black grid grid-cols-2">
                    <td className="p-[10px] text-[15px] flex items-center">Judgment-Free</td>
                    <td className="p-[10px] border-l border-black text-[15px] flex items-center gap-[10px]">
                      <div><svg
                        width="16"
                        height="16"
            ...
            <CarouselItem className="basis-1/1 w-full">
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-black grid grid-cols-2">
                    <td className="p-[10px] text-[15px]">Affordability</td>
                    <td className="p-[10px] border-l border-black text-[15px] flex items-center gap-[10px]  bg-[#e5ff7d]">
                      <div><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="17"
                  ...
                  <tr className="border-b border-black grid grid-cols-2">
                    <td className="p-[10px] text-[15px] flex items-center">Approachability</td>
                    <td className="p-[10px] border-l border-black text-[15px] flex items-center gap-[10px]  bg-[#e5ff7d]">
                      <div><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                  ...
                  <tr className="border-b border-black grid grid-cols-2">
                    <td className="p-[10px] text-[15px]">Judgment-Free</td>
                    <td className="p-[10px] border-l border-black text-[15px] flex items-center gap-[10px]  bg-[#e5ff7d]">
                      <div><svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
