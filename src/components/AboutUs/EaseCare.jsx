...
const StarBadge = () => (
  <div
    className="bg-[#e5ff7d] rounded-[14.5px] flex items-center justify-center flex-shrink-0"
    style={{ width: 19.743, height: 19.743 }}
  >
    <img
      src="/about-us/stats/star.webp"
      alt=""
      style={{ width: 11.105, height: 11.105 }}
    />
  </div>
);
...
function EaseCare() {
  return (
    <section className="overflow-visible w-full bg-white">
      <div className="relative max-w-[1440px] mx-auto" style={{ height: 638 }}>
        {/* ── Stat circles ── overlapping 138px up into the photos section */}
        <div
          className="flex absolute left-1/2 z-10 justify-center items-start -translate-x-1/2"
          style={{ top: -138 }}
        >
          {/* 94% — lime */}
          <div
          ...
          <div
            ...
            style={{ width: 232, height: 232, marginRight: -14 }}
          >
            <p className="font-miniature text-[72px] leading-[83px]">20+</p>
            <p className="text-[18px] font-normal tracking-[-0.36px] leading-[1.25] capitalize mt-1 px-4">
        ...
        >
          ...
          <p className="text-[18px] font-normal leading-[1.25] text-[rgba(13,13,13,0.7)]">
            ...
            practice, coach vetting process, and session framework is grounded
            in real mental health expertise not just business logic.
          </p>
        </div>

        {/* ── 1000+ lime-green card ── */}
        <div
          className="absolute bg-[#e5ff7d] rounded-[40px] overflow-hidden flex flex-col items-center justify-center gap-4"
          style={{
            left: 916,
            top: "calc(50% + 32px)",
            transform: "translateY(-50%)",
