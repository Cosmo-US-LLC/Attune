  ...
  return (
    <>
      <div className="flex flex-row border border-black ">
        <div className="bg-[#D43525] flex w-[25%] border-r border-black">
          <img
            src={"/desktop4/feel-heard/smiling-girl.webp"}
            alt="smilinggirl"
            className="object-cover w-full h-auto px-8"
          />
        </div>
        <div className="flex mt-20 lg:pl-16 xl:pl-32 2xl:pl-40 3xl:pl-48">
          <div className="flex flex-row">
            <div className="flex flex-col mb-4">
              ...
              <a href="https://innovacare.tech/listenerhub/signup" className="flex w-fit">
                <button className="bg-[#5200FF] text-white w-[160px] hover:bg-purple-800 mt-4 py-3 rounded-full">
                  Connect Now
                </button>
              </a>
            </div>
            <div className="flex flex-row lg:pl-0 3xl:pl-8 ">
              <img
                ...
                alt="smilinggirl"
                className="absolute z-10 lg:mt-[70px] xl:mt-9 2xl:mt-16 lg:w-[280px] lg:h-[170px] xl:w-[330px] xl:h-[210px] lg:pl-16 xl:pl-32 2xl:pl-32 3xl:pl-6 object-contain "
              />
