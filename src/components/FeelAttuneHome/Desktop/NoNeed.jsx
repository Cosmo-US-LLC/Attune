      ...
      <div className="">
        <div className="max-w-[1440px] mx-auto px-[105px] pt-[65px] grid grid-cols-11">
          <div className="grid grid-rows-2 col-span-3 max-h-[500px]">
            <div className="">
              <img
                src="assets/desktop1/no-need/sun.svg"
                alt="Sun"
            ...
            <div className="flex justify-end items-end">
              <img
                src="assets/desktop1/no-need/bird.svg"
                alt="Bird"
          ...
          <div className="relative z-10 h-[300px] overflow-visible col-span-5">
            <img
              src="assets/desktop1/no-need/girl.webp"
              alt="Moods"
          ...
          <div className="grid grid-rows-2 col-span-3">
            <div className="flex justify-center items-center">
              <img
                src="assets/desktop1/no-need/mood.svg"
                alt="Moods"
            ...
            <div className="flex items-center justify-end">
              <img
                src="assets/desktop1/no-need/clouds.svg"
                alt="Clouds"
