function Listener() {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      <div className="flex flex-col flex-wrap listener-desktop-1 md:flex-row">
        <div className="w-full md:w-[45%]"></div>

        <div className="w-full md:w-[55%] flex justify-center px-6 md:px-12 lg:px-16">
          <div className="w-full max-w-[647px] h-[676px] lg:mt-16 xl:mt-20 2xl:mt-32">
            <div className="bg-white border border-black rounded-[48px] p-[16px] md:p-[20px] lg:p-[48px] space-y-[22px]">
              ...
              <ul className="leading-[28px] md:leading-[24px] pl-6 md:pl-12 lg:pl-10">
                {cardArr.map((item, index) => (
                  <li
                    key={index}
                    className="relative text-[16px] md:text-[16px] font-[400] pb-4 md:pb-6 w-[429px] pl-5"
                  >
                    <span
                      style={{
                        content: "''",
