...
<h1 className='font-miniature text-center text-[76px] mb-[34px] leading-[110px]'>Sessions that Works best for you</h1>
<div>
...
function SessionsCards({ bandge, title,subtitle , item1,item2,item3,isSubtitle }) {
    return (
      <div className="bg-white border border-black min-h-[386px] px-[29px] py-[37px] rounded-[20px] space-y-[10px]">
        ...
        <div className="">
          <h3 className={`text-black font-miniature leading-[50px] text-[50px] ${isSubtitle ? "mb-[4px]":"mb-[45px]" } font-[400px]`}>{title}</h3>
