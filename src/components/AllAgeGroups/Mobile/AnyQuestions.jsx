  ...
  const questions = [
    ...
    },
    {
      ...
      answer: (
        <div>
          <p>
            The Listeners offer a supportive and judgment-free space to share
          ...
          <br />
          <p className="mt-4">
            However, it’s important to note that Listeners are not licensed
            mental health professionals. They do not diagnose, treat mental
            illnesses, or provide clinical interventions. If you’re experiencing
            severe emotional distress, trauma, or clinical conditions such as
            anxiety, depression, or addiction, we recommend seeking support from
            a qualified therapist or counselor. <br />
            <br /> Listeners is here to complement—not replace—professional
            mental health care, offering empathetic support for everyday
            challenges.
          </p>
        </div>
      ),
