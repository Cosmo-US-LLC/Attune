function Hero() {
  return (
    <div className="lg:min-w-[1000px] xl:min-w-[1260px] 2xl:min-w-[1420px] flex flex-row overflow-hidden ">
      ...
      <div className="bg-[#95ADF0] min-w-[50%] flex flex-col justify-center p-20 ">
        <h1 className="font-miniature w-[558px] lg:mt-8 xl:mt-4 text-[53px] font-[700] text-white leading-[62px]">
          Break Free from Mental Health Barriers
        </h1>
        <p className="mt-4 max-w-[477px] text-white font-inter text-[16px] font-[400] leading-[26px] max-xl:text-[15px] pr-2">
          No stigma. No labels. Just real conversations. Whether you’re facing
          stress, anxiety, or emotional overwhelm, you don’t have to go through
          it alone. Our trained Listeners offer a safe space to talk, vent, and
          feel heard—on your terms.
        </p>
        <a
