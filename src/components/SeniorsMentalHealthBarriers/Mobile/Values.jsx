export default function Values() {
  const values = [
    {
      bg: "bg-[#E5FF7D]",
      img: "assets/desktop3/coreValues/c-1.svg",
    ...
    {
      bg: "bg-[#FFA8ED]",
      img: "assets/desktop3/coreValues/c-2.svg",
    ...
    {
      bg: "bg-[#6FE0D1]",
      img: "assets/desktop3/coreValues/c-3.svg",
  ...
  return (
    <>
      <div className=" py-[30px] px-5 space-y-6">
        <h3 className="text-center font-miniature text-[38px]">
          Our Core Values
        </h3>
        {values?.map((test, id) => (
          <div
          ...
          >
            ...
            <div className="space-y-[2px]">
              <h3 className="font-miniature text-[40px] mb-6 leading-[45px]">
                {test?.title}
              </h3>
