              ...
              <td className="p-[10px] text-[14px] flex leading-[98%] items-center gap-[10px]">
                <div>
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <rect y="0.5" width="16" height="16" rx="8" fill="#01C4FF" />
                    <path
