  ...
  return (
    <div className="bg-[#F4EFEA] max-2xl:px-[100px] px-[150px] py-[50px] w-full">
      <div className="max-w-[1440px] mx-auto w-full h-full flex flex-row justify-center items-center max-xl:gap-[26px] gap-[41px]">
        ...
        <div className="flex items-center justify-center  space-x-[34px] rounded-[30px] bg-white py-[33px] px-[31px] w-fit">
          <img
            src={"/desktop3/as-seen-in/logo1.webp"}
            alt="Time Logo"
            className="h-[37px] w-[102px]"
          />
          <img
            src={"/desktop3/as-seen-in/logo2.webp"}
            alt="NewsNation Logo"
            className="h-[37px] w-[120px]"
          />
          <img
            src={"/desktop3/as-seen-in/logo3.webp"}
            alt="Axios Logo"
            className="h-[56px] w-[137px]"
          />
          <img
            src={"/desktop3/as-seen-in/logo4.webp"}
            alt="BBC Logo"
            className="h-[58px] w-[158px]"
          />
          <img
            src={"/desktop3/as-seen-in/logo5.webp"}
            alt="INC Logo"
            className="h-[47px] w-[131px]"
          />
          <img
            src={"/desktop3/as-seen-in/logo6.webp"}
            alt="INC Logo"
