...
function Testimonials() {
  const testimonials = [
    {
      bg: 'bg-[#E5FF7D]',
      img: "/desktop2/testimonials/test-1.png",
      title: "Jake, 24",
    ...
    {
      bg: 'bg-[#FF6F61]',
      img: "/mobile2/testimonials/emily.png",
    ...
    {
      bg: 'bg-[#6FE0D1]',
      img: "/mobile2/testimonials/david.png",
      title: "David Lee, 31",
  ...
  return (
    <div className="bg-white py-[30px] px-5 space-y-6">
      ...
      <img src="/desktop2/testimonials/progress95.png" alt="pg95" className="w-full"/>
      ...
      <span className="font-semibold">95%</span> of young adults report feeling emotionally supported after a session.
        ...
        <div className="space-y-2">
      <img src="/desktop2/testimonials/progress75.png" alt="pg75" className="w-full"/>
      <p className="text-[15px] pl-1">
