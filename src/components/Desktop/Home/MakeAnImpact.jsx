...
function MakeAnImpactCarousel() {
  const testimonials = [
    {
      bg: "bg-[#E5FF7D]",
      img: "/desktop/testimonials/test1.png",
      title: "Jake, 24",
    ...
    {
      bg: "bg-[#FF6F61]",
      img: "/desktop/testimonials/test2.png",
    ...
    {
      bg: "bg-[#6FE0D1]",
      img: "/desktop/testimonials/test3.png",
      title: "David Lee, 31",
  ...
  return (
    <div className="bg-[#F4EFEA]">
      <div className="max-w-[1440px] mx-auto  p-[105px] pt-[85px] space-y-6">
        ...
        <div className=" flex flex-row pb-[70px]">
          <div className="flex flex-col">
            <img
              src="/desktop/testimonials/progress95.png"
              alt="pg95"
          ...
          <div className="flex flex-col">
            <img
              src="/desktop/testimonials/progress75.png"
              alt="pg95"
              className="w-[80%] h-[117px] object-contain rounded-full"
            />
            <h3 className="text-[25px] pl-2">
        ...
        <Carousel className="">
          <CarouselContent>
            {testimonials?.map((test, id) => (
              <CarouselItem
                key={id}
                className="max-xl:basis-1/2 basis-1/3 w-full"
              >
                <div
                  className={
