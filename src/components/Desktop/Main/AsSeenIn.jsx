    ...
    <div className="bg-[#F4EFEA] max-2xl:px-[100px] px-[150px] py-[50px] w-full">
      <div className="max-w-[1440px] mx-auto w-full h-full flex flex-row justify-center items-center max-xl:gap-[26px] gap-[41px]">
        ...
        <div className="flex items-center justify-center max-xl:space-x-[33px] space-x-[73px] rounded-[30px] bg-white py-[33px] px-[51px] w-fit">
          ...
          <img src={"/desktop/as-seen-in/logo1.webp"} alt="Time Logo" className="max-xl:h-[25px] h-[32px] w-[102px]" />
          <img src= {"/desktop/as-seen-in/news-nation.svg"} alt="NewsNation Logo" className="max-xl:h-[25px] h-[41px] w-[135px]" />
          <img src={"/desktop/as-seen-in/axios.svg"} alt="Axios Logo" className="max-xl:h-[20px] h-[27px] w-[106px]" />
          <img src={"/desktop/as-seen-in/bbc.svg"} alt="BBC Logo" className="max-xl:h-[25px] h-[33px] w-[116px]" />
          <img src={"/desktop/as-seen-in/inc.svg"} alt="INC Logo" className="max-xl:h-[25px] h-[31px] w-[90px]" />
