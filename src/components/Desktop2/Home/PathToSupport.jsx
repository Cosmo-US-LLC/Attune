  ...
  return (
    <div className="bg-gray-50 py-[110px] px-[110px]" id="PathToSupport">
      <div className="max-w-[1440px] mx-auto space-y-[60px]">
        ...
        <h6 className="text-[18px] px-16 text-center lg:min-w-[600px] xl:min-w-[700px] 2xl:min-w-[800px] 3xl:min-w-[1001px] font-[400]">Loneliness among young adults is more common than you think. As you navigate through major life transitions—like starting college, entering the workforce, or building new relationships—it’s easy to feel disconnected. You’re not alone—61% of young adults report feeling serious loneliness..</h6>
