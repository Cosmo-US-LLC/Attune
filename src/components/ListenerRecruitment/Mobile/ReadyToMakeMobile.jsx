...
function ReadyToMakeMobile() {
  return (
    <section className="h-[450px] readyToMakeMobile flex flex-col justify-center items-center px-6 text-center">
      <div className="flex flex-col space-y-4">
        <p className="font-miniature text-[38px] leading-normal font-[400]">
...
export default ReadyToMakeMobile;
