function CoachesSection() {
  return (
    <div className="bg-[#A78BFA] w-full overflow-hidden">
      <div className=" max-w-[1220px] px-[20px] py-[30px] mx-auto">
        <div className="max-w-[592px] w-[100%] flex flex-col justify-center ">
          <h1 className="font-miniature text-[35px] text-white leading-normal">
            Coaches, You Can Be a Listener Too!
          </h1>
          <p className="mt-2 text-white font-inter text-[15px] font-[400] leading-[140%]">
            If you're a life coach, wellness coach, or someone passionate about
            personal growth and development, becoming a Listener is a perfect
            fit for you. Listeners provide supportive, empathetic conversations
            that help individuals navigate life's challenges—without the
            formality of traditional therapy. <br />
            You already have the skills to listen, empower, and guide people. As
            a Listener, you can use these skills to support others in a
            flexible, virtual environment, offering meaningful connections that
        ...
        <div className="border-4 border-[#b49ef6] rounded-[7.279px] w-[100%] max-w-[577px] mt-6  flex justify-center  items-start">
          <img
            src={"/listener-recruitment/desktop/CoachesSection/woman-home.png"}
            alt="Listener"
            className="object-cover w-[100%] rounded-[7.279px] h-auto    "
          />
        </div>
      </div>
    </div>
