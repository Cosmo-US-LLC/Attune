function Hero() {
  return (
    <div className="lg:min-w-[1000px] xl:min-w-[1260px] 2xl:min-w-[1420px] flex flex-row overflow-hidden ">
      ...
      <div className="bg-[#D43525] min-w-[54%] lg:px-12 lg:py-16 xl:p-20 ">
        <h1 className="font-miniature max-w-lg max-xl:text-[79px] lg:mt-8 xl:mt-4 text-[77px] text-white leading-[91px]">
          <span className="font-[600] "> Struggling to</span> <br />
          <span className="text-[#E5FF7D] italic"> Cope? </span>
        </h1>
