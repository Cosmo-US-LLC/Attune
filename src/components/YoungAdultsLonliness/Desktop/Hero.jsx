...
// import phoneImage from "../../../public/desktop2/hero/phone-boy.webp";
...
function Hero() {
  return (
    <div className="lg:min-w-[1000px] xl:min-w-[1260px] 2xl:min-w-[1420px] flex flex-row overflow-hidden ">
      <div className="bg-[#E5FF7D] min-w-[50%] ">
        <div className="relative">
          <img
            src={"/desktop2/hero/Hero-Image.webp"}
            alt="Listener"
      ...
      <div className="bg-[#95ADF0] min-w-[50%] lg:px-12 lg:py-16 xl:p-20 ">
        ...
        <a href="https://signup.feelattune.com/sign-up?_gl=1*46lrc9*_gcl_au*NDQyODE2NjgyLjE3NDY0NTQ3Njc.*_ga*MjEyMDE1OTQyMi4xNzM4NTIxNjMz*_ga_2MGYLNPB9W*czE3NDkwMDA4MzYkbzEwNiRnMCR0MTc0OTAwMDgzNiRqNjAkbDAkaDA" className="flex w-fit">
    ...
    //       <div className="relative">
    //         <img
    //           src={"/desktop2/hero/phone-boy.webp"}
    //           alt="Listener"
