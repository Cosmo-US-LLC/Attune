function SafeSpace() {
  const cardArr = [
    <p>
      <strong>Feel Heard, Without Judgment: </strong>Share your thoughts and
      emotions openly in a safe space.
    </p>,
    <p className="pt-2">
      <strong>Accessible Anytime: </strong>Connect with a Listener when it’s
      convenient for you.
    </p>,
    <p className="pt-2">
    ...
    <p className="pt-2">
      ...
      need without the barriers of traditional services.
    </p>,
  ];

  return (
    <div className="w-full overflow-x-hidden">
      <div className="flex flex-col flex-wrap listenerSeniorsMentalHealthDesktop md:flex-row">
          ...
          <div className="w-full max-w-[646px] flex items-center">
            <div className="bg-white border border-[#E5FF7D] rounded-[20px] p-[16px] md:p-[20px] lg:p-[48px] space-y-[22px]">
              <h3 className="font-miniature text-[30px] lg:text-[24px] xl:text-[50px] leading-[35px] md:leading-[40px] xl:leading-[57px]  text-center md:text-left">
                Meaningful Conversations That Make a Difference
              </h3>
              <p className="text-[16px] font-[400] leading-[26px]">
                See how a compassionate Listener can bring comfort and
                  ...
                  >
                    <span
                      style={{
                        ...
                        height: "30px",
                        backgroundImage:
                          "url('assets/desktop7/listener/tick-circle.svg')",
