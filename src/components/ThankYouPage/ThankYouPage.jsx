...
const ThankYouPage = () => {
  return (
    <div className="flex flex-col items-center justify-center py-10 bg-white">
      <h1 className="text-[62px] md:text-[92px] font-[400] font-miniature text-center text-black capitalize leading-[97px] mb-4">
        Thank You!
      </h1>

      <p className="px-4 mb-8 text-lg md:text-[24px] text-center text-[#000] leading-[26px]">
        We have received your application. <br /> A member of our team will get
        in touch with you soon.
      </p>

      <div className="flex justify-center mb-8">
        <img
          src="/listener-recruitment/thankyou/thank-you.webp"
          alt="Thank You"
          className="w-[200px] md:w-[237px] h-auto mx-2"
        />
      </div>
